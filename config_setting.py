...
class setting_config:
    ...
    datasets = 'private'
    if datasets == 'tn3k':
        data_path = '//datasets/TN3K/dataset/'
    elif datasets == 'DDTI':
        data_path = '//datasets/DDTI/'
    elif datasets == 'private':
        data_path = '//datasets/private/'
    else:
    ...
    if opt == 'Adadelta':
        ...
        weight_decay = 1e-2  # default: 0 – weight decay (L2 penalty)
    ...
    sch = 'CosineAnnealingLR'
    if sch == 'StepLR':
        step_size = epochs // 6  # – Period of learning rate decay.
